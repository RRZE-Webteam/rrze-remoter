...
class Create_Metaboxes {

    public $data;

    public function __construct() {
        $this->data = Metaboxes_Data::Metaboxes_Data_Loader();
    ...
    public function adding_meta_box() {
        ...
        if ($post->post_type == 'remoter') {
            ...
            foreach ($this->data as $box) {
                ...
                add_meta_box(
                        $box['id'], $box['title'], array($this, 'metabox_callback'), $box['post_type'], $box['context'], $box['priority'], $box['args']
                );
            }
        }
    }
